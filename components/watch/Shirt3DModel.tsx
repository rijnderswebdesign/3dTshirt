  ...
  useEffect(() => {
    if (!shirtModel || !bodyTextureMap || !collarTextureMap || !buttonTextureMap || !sleeveTextureMap) {
      console.warn('⚠️ Waiting for all textures to load...', {
        hasshirtModel: !!shirtModel,
        hasInternalDisplayTexture: !!bodyTextureMap,
        hasStrapTexture: !!collarTextureMap,
        hasWatchBaseTexture: !!buttonTextureMap,
        hasMaterialTexture: !!sleeveTextureMap
      });
      return;
    }
